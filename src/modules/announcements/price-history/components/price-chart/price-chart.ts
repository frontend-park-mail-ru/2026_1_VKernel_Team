...
// import template from './price-chart.hbs?raw';
...
//         const chartContainer = this.container.querySelector('#priceChartContainer') as HTMLElement;
//         if (!chartContainer) return;

//         this.createTooltip(chartContainer);
//         this.createChart(chartContainer);
//     }
...
//         if (!this.container) return;
//         const loader = this.container.querySelector('.price-chart-loader') as HTMLElement;
//         if (loader) {
